...
public class ControllerDefinicaoCientifica {
	...
	@PutMapping("/{id}")
	public void updateDefinicaoCientifc(@RequestBody DefinicaoCientifica definicaoCientifica, @PathVariable Long id) {
		   service.updateDefinicaoC(definicaoCientifica, id);
	}
}